        ...
        with open(os.path.join(directory, filename), 'r') as inputfile:
            ...
            if length >= 658:
                for i in range(2, length):
                    ...
                    if (((text_before == "a" and text_after == "a") and (text in consonants)) or ((
                                                                                                          text_bebefore == "a" and text_before == "<p:>" and text_after == "<p:>" and text_afterter == "a") and (
                                                                                                          text in consonants)) or (
                            (text_bebefore == "a" and text_before == "<p:>" and text_after == "a") and (
                            text in consonants)) or (
                            (text_before == "a" and text_after == "<p:>" and text_afterter == "a") and (
                            text in consonants))):
